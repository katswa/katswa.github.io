/* This script uses a filtering function to filter a gallery by tags
   It is an example from JavaScript & jQuery book */

(function() {

    var $imgs = $('#gallery-sorter img');           // Store all images
    var $buttons = $('#gallery-buttons');                   // Store buttons element
    ...
    $imgs.each(function() {                         // Loop through images and
		...
		if (tags) {                                   // If the element had tags
			tags.split(',').forEach(function(tagName) { // Split at comma and
				if (tagged[tagName] == null) {            // If object has no tag
